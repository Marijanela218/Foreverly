        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultCommissionPercent = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bands", x => x.PartnerId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FloralArrangements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FloralArrangements_Partners_PartnerId",
                        column: x => x.PartnerId,
                        principalTable: "Partners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PastryItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PastryItems_Partners_PartnerId",
                        column: x => x.PartnerId,
                        principalTable: "Partners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    PartnerId = table.Column<int>(type: "integer", nullable: false),
                    HasWeddingHall = table.Column<bool>(type: "boolean", nullable: false),
                    OffersCatering = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Restaurants", x => x.PartnerId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PartnerBookings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PartnerBookings_Partners_PartnerId",
                        column: x => x.PartnerId,
                        principalTable: "Partners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PartnerBookings_Weddings_WeddingId",
                        column: x => x.WeddingId,
                        principalTable: "Weddings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WeddingServices_Partners_PartnerId",
                        column: x => x.PartnerId,
                        principalTable: "Partners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WeddingServices_Weddings_WeddingId",
                        column: x => x.WeddingId,
                        principalTable: "Weddings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BandPrices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BandPrices_Bands_BandId",
                        column: x => x.BandId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SeatingAssignments_Guests_GuestId",
                        column: x => x.GuestId,
                        principalTable: "Guests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SeatingAssignments_Tables_TableId",
                        column: x => x.TableId,
            ...
            migrationBuilder.CreateTable(
                name: "WeddingServiceItems",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    WeddingServiceId = table.Column<int>(type: "integer", nullable: false),
                    ItemReferenceType = table.Column<string>(type: "text", nullable: false),
                    ItemReferenceId = table.Column<int>(type: "integer", nullable: true),
                    Name = table.Column<string>(type: "text", nullable: false),
                    Quantity = table.Column<int>(type: "integer", nullable: false),
                    UnitPrice = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    TotalPrice = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WeddingServiceItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WeddingServiceItems_WeddingServices_WeddingServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SongGroupId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlaylistItems_SongGroups_SongGroupId",
                        column: x => x.SongGroupId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BandPrices_BandId",
                table: "BandPrices",
                column: "BandId");

            migrationBuilder.CreateIndex(
                name: "IX_FloralArrangements_PartnerId",
                table: "FloralArrangements",
                column: "PartnerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PartnerBookings_PartnerId",
                table: "PartnerBookings",
                column: "PartnerId");

            migrationBuilder.CreateIndex(
                name: "IX_PartnerBookings_WeddingId",
                table: "PartnerBookings",
                column: "WeddingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlaylistItems_SongGroupId",
                table: "PlaylistItems",
                column: "SongGroupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeatingAssignments_GuestId",
                table: "SeatingAssignments",
                column: "GuestId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SeatingAssignments_TableId",
                table: "SeatingAssignments",
                column: "TableId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WeddingServiceItems_WeddingServiceId",
                table: "WeddingServiceItems",
                column: "WeddingServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_WeddingServices_PartnerId",
                table: "WeddingServices",
                column: "PartnerId");

            migrationBuilder.CreateIndex(
                name: "IX_WeddingServices_WeddingId",
                table: "WeddingServices",
                column: "WeddingId");
        }
